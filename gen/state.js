...
$column: '129',
$type: 'promise',
cond: () => {return this.model.password && this.model.server && this.model.user && this.model.resource}, 
content: () => {return true}, 
})
; }; 
...
$column: '15',
$type: 'promise',
content: () => {return profileStore.connect()}, 
})
; }; 
...
; }; 
    ...
    this.states = states;
    this.transitions = transition.map(el => new Transition(this, el));
    this.onentry = _event => { this.sm.promise({$line: '90',
$column: '15',
$type: 'promise',
...
; }; 
    ...
    let transition = [];
        transition.push({
         ...
         target:"PromoScene", 
        ontransition:_event => { this.sm.script({$line: '145',
$column: '16',
$type: 'script',
...
; }, 
    ...
    this.states = states;
    this.transitions = transition.map(el => new Transition(this, el));
    this.initial = 'ProfileDetails'; this.onexit = _event => { this.sm.script({$line: '172',
$column: '14',
$type: 'script',
...
; }; 
    ...
    this.states = states;
    this.transitions = transition.map(el => new Transition(this, el));
    this.onentry = _event => { this.sm.script({$line: '181',
$column: '15',
$type: 'script',
...
; }; 
    ...
    let transition = [];
        transition.push({
         ...
         target:"CreatePrivateChat", 
        ontransition:_event => { this.sm.script({$line: '208',
$column: '14',
$type: 'script',
...
export class Statem extends StateMachine {
    ...
    get testRegisterScene(): TestRegisterSceneState {return this.getState("TestRegisterScene")};
    ...
    get codePush(): CodePushState {return this.getState("CodePush")};
