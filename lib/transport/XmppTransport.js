...
class XmppTransport {
    constructor(provider, fileService, resource) {
        ...
        provider.onConnected = mobx_1.action(() => (this.connected = true));
        provider.onDisconnected = mobx_1.action(() => (this.connected = false));
        provider.onIQ = mobx_1.action((iq) => {
            this.iq = iq;
        ...
        provider.onMessage = mobx_1.action((msg) => {
        ...
        provider.onPresence = mobx_1.action((stanza) => {
    ...
    login(user, password, host) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                mobx_1.runInAction(() => (this.connecting = true));
                yield timeout(this.provider.login(this.username, this.password, this.host, this.resource), TIMEOUT);
                return true;
            }
            catch (e) {
                mobx_1.runInAction(() => (this.connected = false));
                throw e;
            }
            finally {
                mobx_1.runInAction(() => (this.connecting = false));
            }
        });
    }
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return yield new Promise((resolve, reject) => mobx_1.when(() => this.iq && this.iq.id === id, () => {
                ...
                if (stanza.type === 'error') {
                    reject(stanza.error && stanza.error.text
    ...
    loadRelations(userId, relation = 'following', lastId, max = 10) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const list = children
                .filter(({ jid }) => Strophe.getDomainFromJid(jid))
                .map(({ jid }) => ({ id: Strophe.getNodeFromJid(jid) }));
    ...
    loadChats(max = 50) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return items.map((item) => {
                ...
                return {
                    id: sender,
                    message: processMessage(Object.assign({}, message, { to, from, time: Utils.iso8601toDate(timestamp).getTime() }), this.username),
                };
            });
        });
    }
    ...
    loadOwnBots(userId, lastId, max = 10) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return {
                list: bots.map((item) => (Object.assign({ id: item.id }, utils_1.processMap(item)))),
    ...
    shareBot(id, server, recepients, message, shareAction) {
        const msg = $msg({
...
tslib_1.__decorate([
    mobx_1.action
], XmppTransport.prototype, "login", null);
tslib_1.__decorate([
    mobx_1.action
], XmppTransport.prototype, "register", null);
