...
class HybridTransport {
    ...
    login(user, password, host) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            // parallel login
            const logins = yield Promise.all([this._gql.login(user, password, host), this._xmpp.login(user, password, host)]);
    ...
    loadSubscribedBots(userId, lastId, max) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this._gql.loadSubscribedBots(userId, lastId, max);
        });
    }
}
tslib_1.__decorate([
...
tslib_1.__decorate([
    mobx_1.computed
], HybridTransport.prototype, "resource", null);
tslib_1.__decorate([
    mobx_1.computed
