...
function convertBot(_a) {
    var { lat, lon, isPublic, subscribers } = _a, data = tslib_1.__rest(_a, ["lat", "lon", "isPublic", "subscribers"]);
    ...
    return Object.assign({}, data, { location: { latitude: lat, longitude: lon }, visibility: isPublic ? Bot_1.VISIBILITY_PUBLIC : Bot_1.VISIBILITY_OWNER, guest: contains('GUEST'), visitor: contains('VISITOR'), isSubscribed: contains('SUBSCRIBED') });
}
