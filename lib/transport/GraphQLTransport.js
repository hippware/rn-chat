...
class GraphQLTransport {
    ...
    _loadBots(relationship, userId, after, max = 10) {
      ...
      `,
            ...
            const list = bots.edges.map((e) => convertBot(e.node));
