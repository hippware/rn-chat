...
function convertBot(_a) {
    var { lat, lon, addressData, isPublic, items, subscriberCount, visitorCount, guestCount, subscribers } = _a, data = tslib_1.__rest(_a, ["lat", "lon", "addressData", "isPublic", "items", "subscriberCount", "visitorCount", "guestCount", "subscribers"]);
    try {
