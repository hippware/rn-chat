...
class GraphQLTransport {
    ...
    subscribeBotVisitors() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            this.botGuestVisitorsSubscription = yield this.client
                .subscribe({
                query: graphql_tag_1.default `
          subscription {
            botGuestVisitors {
        ...
        `
                ...
                next: (result) => {
                    ...
                    this.botVisitor = Object.assign({}, update.visitor, { botId: update.bot.id, visitorsSize: update.bot.visitorCount.totalCount, action: update.action });
                }
            });
        });
    }
...
function convertBot(_a) {
    var { lat, lon, image, addressData, isPublic, items, subscriberCount, visitorCount, guestCount, subscribers } = _a, data = tslib_1.__rest(_a, ["lat", "lon", "image", "addressData", "isPublic", "items", "subscriberCount", "visitorCount", "guestCount", "subscribers"]);
    try {
        ...
        return Object.assign({}, data, { image: image ? { id: image.trosUrl, source: { uri: image.fullUrl }, thumbnail: { uri: image.thumbnailUrl } } : null, addressData: addressData || {}, totalItems: items ? items.totalCount : 0, followersSize: subscriberCount.totalCount - 1, visitorsSize: visitorCount.totalCount, guestsSize: guestCount.totalCount, location: { latitude: lat, longitude: lon }, visibility: isPublic ? Bot_1.VISIBILITY_PUBLIC : Bot_1.VISIBILITY_OWNER, guest: contains('GUEST'), visitor: contains('VISITOR'), isSubscribed: contains('SUBSCRIBED') });
    }
    catch (e) {
