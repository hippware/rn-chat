    ...
    constructor(log = (param) => null) {
        ...
        this.login = (username, password, host, resource) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                ...
                self._connection.connect(utils_1.default.getJid(username, this.host, resource), password, (status, condition) => {
                    switch (status) {
        ...
        this._onPresence = (stanza) => {
            const data = utils_1.default.parseXml(stanza);
            this.onPresence && this.onPresence(data.presence);
            return true;
        };
        this._onMessage = (stanza) => {
            const data = utils_1.default.parseXml(stanza).message;
