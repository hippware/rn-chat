...
exports.Message = mobx_state_tree_1.types
    ...
    id: mobx_state_tree_1.types.optional(mobx_state_tree_1.types.string, utils_1.default.generateID),
    archiveId: '',
    from: Profile_1.ProfileRef,
    to: '',
    ...
    clear: () => {
        self.media = null;
        self.body = '';
        self.id = utils_1.default.generateID();
    },
    setBody: (text) => {
        self.body = text;
    }
