    ...
    return {
        actions: {
            afterAttach: () => {
                ...
                subscribers.setRequest(self.service.loadRelations.bind(self.service, self.id, 'follower'));
                posts = BotPost_1.BotPostPaginableList.create({});
                posts.setRequest(self.service.loadRelations.bind(self.service, self.id, 'following'));
            }
        },
        views: {
            get subscribers() {
