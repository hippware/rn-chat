...
exports.BotPost = mobx_state_tree_1.types
    .compose(mobx_state_tree_1.types.compose(Base_1.Base, Timeable_1.Timeable, Loadable_1.Loadable), Uploadable_1.createUploadable('image', (self) => `redirect:${mobx_state_tree_1.getParent(self).server}/bot/${mobx_state_tree_1.getParent(self).id}`), mobx_state_tree_1.types.model('BotPost', {
