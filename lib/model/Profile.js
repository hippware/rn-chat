...
exports.Profile = mobx_state_tree_1.types
    ...
    .named('Profile')
    .extend(self => {
    let followers, followed, ownBots, subscribedBots, geofenceBots;
    ...
    return {
        ...
        views: {
            ...
            get activeBots() {
                const arr = geofenceBots.list.filter((bot) => bot.visitorsSize).map((data, index) => ({ data, index }));
                return arr
                    .sort((a, b) => {
...
exports.ProfileRef = mobx_state_tree_1.types.maybe(mobx_state_tree_1.types.reference(exports.Profile, {
    get(id, parent) {
        return parent && parent.service && parent.service.profiles && mobx_state_tree_1.isAlive(parent.service.profiles.get(id)) && parent.service.profiles.get(id);
    },
    set(value) {
        return value.id;
    }
