    ...
    return {
        actions: {
            afterAttach: () => {
                ...
                followers.setRequest(self.service.loadRelations.bind(self.service, self.id, 'follower'));
                followed = exports.ProfilePaginableList.create({});
                followed.setRequest(self.service.loadRelations.bind(self.service, self.id, 'following'));
            }
        },
        views: {
            get isOwn() {
