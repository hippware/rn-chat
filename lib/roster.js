...
exports.default = mobx_state_tree_1.types
    ...
    return {
        ...
        processItem: function (item) {
            ...
            var rolesArr = roles && roles.role ? Array.isArray(roles.role) ? roles.role : [roles.role] : [];
            var data = {
                user: user,
                firstName: firstName,
                lastName: lastName,
    ...
    .actions(function (self) {
    var _a = mobx_state_tree_1.getEnv(self), provider = _a.provider, storage = _a.storage, logger = _a.logger;
    function loadFromStorage() {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var modelName;
            return tslib_1.__generator(this, function (_a) {
                modelName = mobx_state_tree_1.getType(self).name;
                logger.log('WOCKY: loadFromStorage', modelName);
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        storage.getItem(modelName, function (error, data) {
                            if (data) {
                                try {
                                    mobx_state_tree_1.applySnapshot(self, JSON.parse(data));
                                }
                                catch (err) {
    ...
    return {
        afterCreate: function () {
            handler1 = mobx_1.autorun('roster.handler1', function () {
            ...
            handler2 = mobx_1.autorun('roster.handler2', function () {
                if (self.connected) {
                    self.requestRoster();
                }
                else {
                    self.roster.forEach(function (p) {
