...
function convert(data) {
    return data.field.reduce((total, current) => {
        if (current.var === 'subscribers+size') {
            ...
            total.owner = utils_1.default.getNodeJid(current.value);
        }
        else if (current.var === 'updated') {
            total.time = utils_1.default.iso8601toDate(current.value).getTime();
        }
        else {
...
exports.default = mobx_state_tree_1.types
    ...
    removeBot: mobx_state_tree_1.flow(function* (bot) {
