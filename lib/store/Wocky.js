...
const XmppTransport_1 = require("./XmppTransport");
const OwnProfile_1 = require("../model/OwnProfile");
const Profile_1 = require("../model/Profile");
var Profile_2 = require("../model/Profile");
exports.Profile = Profile_2.Profile;
const Factory_1 = require("./Factory");
const Base_1 = require("../model/Base");
var Base_2 = require("../model/Base");
exports.Base = Base_2.Base;
exports.SERVICE_NAME = Base_2.SERVICE_NAME;
...
exports.Wocky = mobx_state_tree_1.types
    ...
    .extend(self => {
    const { provider, fileService } = mobx_state_tree_1.getEnv(self);
    let transport;
    return {
        views: {
            get snapshot() {
        ...
        actions: {
            afterCreate: () => {
                transport = new XmppTransport_1.XmppTransport(provider, fileService, self.resource);
            },
            ...
            loadProfile: mobx_state_tree_1.flow(function* (id) {
                ...
                let res = self.profiles.get(id, data);
                if (isOwn) {
                    if (!self.profile) {
                        self.profile = self.create(OwnProfile_1.OwnProfile, Object.assign({ id }, data, { status: 'available' }));
                    }
                    else {
                        self.load(self.profile, data);
                    }
                    if (self.profile.handle)
                        self.setSessionCount(3);
                }
                return res;
            }),
    ...
    afterCreate: () => {
        ...
        mobx_1.autorun('ProfileStore', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        mobx_1.reaction(() => self.connected, () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (!self.version) {
