...
exports.Wocky = mobx_state_tree_1.types
    ...
    _loadGeofenceBots: mobx_state_tree_1.flow(function* (userId, lastId, max = 10) {
        yield utils_1.waitFor(() => self.connected);
    ...
    _onBotVisitor: mobx_state_tree_1.flow(function* (_a) {
        var { botId, action, visitorsSize, id } = _a, data = tslib_1.__rest(_a, ["botId", "action", "visitorsSize", "id"]);
        if (self.bots.get(botId)) {
            const bot = self.bots.get(botId);
            if (action === 'ARRIVE') {
