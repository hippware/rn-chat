...
class XmppTransport {
        ...
        provider.onMessage = (msg) => {
            if (msg.body || msg.media || msg.image || msg.result) {
                ...
                if (msg[EXPLORE_NEARBY].bot) {
                    ...
                    this.geoBot = Object.assign({ id: bot.id }, processMap(bot));
                }
            }
    ...
    login(user, password, host) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.provider.login(this.username, this.password, this.host, this.resource);
                return true;
            }
            catch (e) {
                throw e;
    ...
    disconnect() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield new Promise(resolve => mobx_1.when(() => !this.connected, resolve));
        });
    }
    ...
    loadProfile(user) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return Object.assign({ id }, processMap(stanza));
        });
    }
    requestProfiles(users) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return arr.map((user) => (Object.assign({ id: user.user }, processMap(user))));
        });
    }
    updateProfile(d) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    lookup(handle) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return Object.assign({ id: user }, processMap(stanza.results.item));
        });
    }
    remove() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    unfollow(username) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield this.removeFromRoster(username);
        });
    }
    block(username) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    loadChats(max = 50) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return items.map((item) => {
                ...
                return { id: sender, message: processMessage(Object.assign({}, message, { to, from, time: utils_1.default.iso8601toDate(timestamp).getTime() }), this.username) };
            });
        });
    }
    generateId() {
    ...
    loadOwnBots(userId, lastId, max = 10) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return { list: bots.map((item) => (Object.assign({ id: item.id }, processMap(item)))), count: parseInt(data.bots.set.count) };
        });
    }
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return {
                ...
                list: res.map((x) => {
                    ...
                    const profile = {
                        id: utils_1.default.getNodeJid(x.author),
    ...
    loadBot(id, server) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield this.sendIQ(iq);
            return Object.assign({ id: data.bot.id }, processMap(data.bot));
        });
    }
    ...
    loadUpdates(ver) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return { list, version, bots: bots.map((bot) => (Object.assign({ id: bot.id }, processMap(bot)))) };
        });
    }
    loadHomestream(lastId, max = 3) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return { list, count, version, bots: bots.map((bot) => (Object.assign({ id: bot.id }, processMap(bot)))) };
        });
    }
...
function processMessage(stanza, ownUserId) {
    ...
    const from = utils_1.default.getNodeJid(jid);
    ...
    try {
        ...
        if (item.message) {
            ...
            if (event && event.item && event.item.entry) {
                ...
                return { id, bot: eventId, time, post: { id: eventId + id, image: entry.image, content: entry.content, profile: utils_1.default.getNodeJid(author) } };
            }
            if (message['bot-description-changed'] && message['bot-description-changed'].bot) {
                ...
                return { id: item.id, bot: noteBot.id, time: utils_1.default.iso8601toDate(item.version).getTime(), note: noteBot.description };
            }
