  ...
  constructor(provider, fileService, resource) {
    ...
    provider.onMessage = msg => {
      if (msg.body || msg.media || msg.image || msg.result) {
        const _a = processMessage(Object.assign({}, msg, {unread: true}), this.username),
          {chatId} = _a,
          message = tslib_1.__rest(_a, ['chatId'])
...
tslib_1.__decorate([mobx_1.observable], XmppTransport.prototype, 'connected', void 0)
tslib_1.__decorate([mobx_1.observable], XmppTransport.prototype, 'connecting', void 0)
tslib_1.__decorate([mobx_1.observable], XmppTransport.prototype, 'iq', void 0)
tslib_1.__decorate([mobx_1.observable], XmppTransport.prototype, 'rosterItem', void 0)
tslib_1.__decorate([mobx_1.observable], XmppTransport.prototype, 'message', void 0)
tslib_1.__decorate([mobx_1.observable], XmppTransport.prototype, 'presence', void 0)
tslib_1.__decorate([mobx_1.observable], XmppTransport.prototype, 'username', void 0)
tslib_1.__decorate([mobx_1.observable], XmppTransport.prototype, 'password', void 0)
tslib_1.__decorate([mobx_1.observable], XmppTransport.prototype, 'host', void 0)
tslib_1.__decorate([mobx_1.observable], XmppTransport.prototype, 'geoBot', void 0)
tslib_1.__decorate([mobx_1.observable], XmppTransport.prototype, 'notification', void 0)
...
function fromCamelCase(data = {}) {
  const {firstName, userID, phoneNumber, lastName, sessionID, uuid} = data,
    result = tslib_1.__rest(data, ['firstName', 'userID', 'phoneNumber', 'lastName', 'sessionID', 'uuid'])
  if (phoneNumber) {
...
function processRosterItem(item = {}, host) {
  const {handle, roles, avatar, jid, group, subscription, ask, created_at} = item,
    props = tslib_1.__rest(item, ['handle', 'roles', 'avatar', 'jid', 'group', 'subscription', 'ask', 'created_at'])
