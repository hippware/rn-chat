...
describe('parse', () => {
  step('test message event', () => {
    const test =
      '<message xmlns="jabber:client" from="1a175ee4-55d5-11e6-8fee-0eea5386eb69@staging.dev.tinyrobot.com/59C05E385AEB3C1471977007528431" to="d6976ac8-5a3a-11e6-8008-0e2ac49618c7@staging.dev.tinyrobot.com" type="chat" id="s1471977049615972"><body>The timestamp is the date I opened the app.</body><archived by="d6976ac8-5a3a-11e6-8008-0e2ac49618c7@staging.dev.tinyrobot.com" id="AEM1BKKVS4G1"/><delay xmlns="urn:xmpp:delay" from="staging.dev.tinyrobot.com" stamp="2016-08-23T18:30:49.704000Z">Offline Storage</delay></message>'; // eslint-disable-line
