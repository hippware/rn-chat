...
describe('message', function () {
  ...
  //     }
  //     when(
  //         () => model.profile && model.profile.avatar && (model.profile.avatar.source || model.profile.avatar.error),
  //         () => {
...
describe('message', function () {
  ...
  step('register/login7', function (done) {
    ...
    // go to create message
    when(
      () => statem.chat.active && model.profile,
      async () => {
