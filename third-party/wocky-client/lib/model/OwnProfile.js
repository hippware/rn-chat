...
exports.OwnProfile = mobx_state_tree_1.types
    .compose(mobx_state_tree_1.types.compose(Profile_1.Profile, Uploadable_1.createUploadable('avatar', 'all'), Updatable_1.createUpdatable(self => self.service._updateProfile(mobx_state_tree_1.getSnapshot(self)))), mobx_state_tree_1.types.model('OwnProfile', {
