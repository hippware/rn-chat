...
export const Bot = types
  .compose(
    ...
    types.model('Bot', {
      ...
      radius: 100,
      owner: types.maybeNull(types.reference(types.late(() => Profile))),
      image: FileRef,
      description: '',
      ...
      subscribers: types.optional(types.late(() => ProfilePaginableList), {}),
      guests: types.optional(types.late(() => ProfilePaginableList), {}),
      visitors: types.optional(types.late(() => ProfilePaginableList), {}),
