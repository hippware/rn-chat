...
describe('New GraphQL conversation tests', () => {
  ...
  //   await waitFor(
  //     () => alice.profile!.sortedFriends.length === 1 && bob.profile!.sortedFriends.length === 1,
  //     "bob and alice aren't friends in time"
  //   )
  //   expect(alice.profile!.sortedFriends[0].id).toEqual(bob.username)
  //   expect(bob.profile!.sortedFriends[0].id).toEqual(alice.username)
