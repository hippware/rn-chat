...
export async function createXmpp(num?: number, phoneNum?: string): Promise<IWocky> {
  try {
    ...
    const gql = new GraphQLTransport('testing', host, '1.1.4', 'ios', 'iPhone 1')
...
export const homestreamTestData = {
  ...
  items: {
            ...
            bot: {
              ...
              field: [
                ...
                {var: 'total_items', type: 'int', value: '2'},
                {
                  var: 'jid',
                  type: 'jid',
                  value: 'testing.dev.tinyrobot.com/bot/f9002b8a-0a52-11e8-b066-0a580a0206c7',
                },
                ...
                {var: 'id', type: 'string', value: 'f9002b8a-0a52-11e8-b066-0a580a0206c7'},
                {
                  ...
                  type: 'string',
                  value:
                    'tros:f57c6690-0a52-11e8-bc08-0a580a02057d@testing.dev.tinyrobot.com/file/fab30420-0a52-11e8-ba6a-0a580a0206c7',
                },
                {
                  var: 'location',
                  type: 'geoloc',
                ...
                {var: 'subscribers+size', type: 'int', value: '1'},
                {
                  ...
                  type: 'string',
                  value: '28b6abe8d4038edbf742297f13af0786',
                },
                ...
                {var: 'updated', type: 'timestamp', value: '2018-02-05T09:00:19.649618Z'},
                {
                  var: 'owner',
                  type: 'jid',
                  value: 'f57c6690-0a52-11e8-bc08-0a580a02057d@testing.dev.tinyrobot.com',
                },
              ],
    ...
    set: {
      ...
      first: {
        index: '0',
        '#text': 'testing.dev.tinyrobot.com/bot/3d577dbe-09b4-11e8-b7e5-0a580a02057d',
      },
      ...
      bot: [
        {
          ...
          field: [
            ...
            {var: 'total_items', type: 'int', value: '2'},
            {
              var: 'jid',
              type: 'jid',
              value: 'testing.dev.tinyrobot.com/bot/3d577dbe-09b4-11e8-b7e5-0a580a02057d',
            },
            {var: 'address', type: 'string'},
            {var: 'address_data', type: 'string', value: 'null'},
            {var: 'alerts', type: 'int', value: '0'},
            ...
            {var: 'id', type: 'string', value: '3d577dbe-09b4-11e8-b7e5-0a580a02057d'},
            {
              ...
              type: 'string',
              value:
                'tros:39e09af8-09b4-11e8-80d4-0a580a02057d@testing.dev.tinyrobot.com/file/3efde978-09b4-11e8-98a0-0a580a02057d',
            },
            {
              var: 'location',
              type: 'geoloc',
            ...
            {var: 'updated', type: 'timestamp', value: '2018-02-04T14:03:59.953149Z'},
            {
              var: 'owner',
              type: 'jid',
              value: '39e09af8-09b4-11e8-80d4-0a580a02057d@testing.dev.tinyrobot.com',
            },
          ],
          tags: [{var: 'tags', type: 'tags'}, null],
          subscribed: 'false',
          ...
          location: {
            geoloc: {xmlns: 'http://jabber.org/protocol/geoloc', lat: '1.300000', lon: '2.300000'},
          },
          visibility: '100',
          radius: '3.00000000000000000000e+01',
          server: 'testing.dev.tinyrobot.com',
        ...
        },
        {
          ...
          field: [
            ...
            {var: 'total_items', type: 'int', value: '0'},
            {
              var: 'jid',
              type: 'jid',
              value: 'testing.dev.tinyrobot.com/bot/45f3c018-09b4-11e8-a764-0a580a02057d',
            },
            {var: 'address', type: 'string'},
            {var: 'address_data', type: 'string', value: 'null'},
            {var: 'alerts', type: 'int', value: '0'},
          ...
          id: '45f3c018-09b4-11e8-a764-0a580a02057d',
          location: {
            geoloc: {xmlns: 'http://jabber.org/protocol/geoloc', lat: '1.200000', lon: '2.200000'},
          },
          visibility: '100',
          radius: '3.00000000000000000000e+01',
          server: 'testing.dev.tinyrobot.com',
