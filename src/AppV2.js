        ...
        <Stack key='rootStack' initial hideNavBar>
          <Stack key='root' tabs hideTabBar hideNavBar lazy>
            <Stack key='launch' hideNavBar lightbox type='replace'>
              <Scene key='load' component={Launch} on={service.hydrate} success='checkProfile' failure='testRegisterScene' />
              ...
              <Scene key='checkHandle' on={() => service.profile.handle} success='logged' failure='testRegisterScene' />
              <Scene key='testRegister' on={store.profileStore.testRegister} success='connect' failure='testRegisterScene' />
