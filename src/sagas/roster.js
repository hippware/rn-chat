...
function* watchIncomingPresences(){
    while (true){
        ...
        if (presence.type === 'subscribe'){
            console.log("SUBSCRIBE_REQUEST_RECEIVED", presence);
...
export default function* root() {
    yield [
        ...
        fork(function *(){yield* takeEvery(profile.LOGIN_SUCCESS, function*(){ const list = yield roster.requestRoster();yield put(actions.rosterReceived(list))})}),
