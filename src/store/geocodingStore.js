  ...
  async details(placeId){
    try {
      ...
      if (json.status === 'ZERO_RESULTS') {
        ...
        return {name: json.result.name, formatted_address: json.result.formatted_address, latitude:json.result.geometry.location.lat, longitude:json.result.geometry.location.lng};
      }
    } catch (e) {
