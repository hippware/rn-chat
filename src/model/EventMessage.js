...
export default class EventMessage extends Event {
  ...
  id: string;
  @computed get isHidden(){ return !this.message || (this.bot && !this.bot.loaded) || (this.target ? this._isHidden || this.target.hidePosts : null)};
  @observable message: Message;
  @observable bot: Bot;
  @observable profile: Profile;
  @computed get target():Profile { return this.profile }
  @computed get date(): Date { return this.message && this.message.time }
  @computed get dateAsString(): string { return this.message ? moment(this.date).calendar() : '' }
