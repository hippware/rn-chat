...
export default class Profile {
  ...
  async validate(name: string) {
    return new Promise((resolve, reject) => {
      ...
      validate.async(value, validationModel).then(
        (res) => {
          this.isValid = true;
          resolve(res);
        },
