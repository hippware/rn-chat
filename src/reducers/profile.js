...
export default function* reducer(state = {}, action) {
    switch (action.type) {
        ...
        case PROFILE+SUCCESS:
            return action.data.own ? {...state, ...action.data, displayName:displayName({...state, ...action.data})} : state;
        ...
        case PROFILE_UPDATE+SUCCESS:
            return {...state, ...action.data, displayName:displayName({...state, ...action.data}), error: undefined};
