...
const App = () => (
  <Provider store={store} {...store} analytics={analytics} codePushStore={codePushStore} notificationStore={notificationStore} reportStore={reportStore} pushStore={pushStore}>
    <ErrorHandler>
      <View style={{flex: 1}}>
        <TinyRobotRouter />
        <NotificationBanner />
