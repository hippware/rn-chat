                       ...
                       footer={
                        <View style={{position:'absolute',top:-5,left:30*k,right:0,height:40*k}}>
                          <View style={{flex:1, flexDirection:'row'}}>
                            ...
                            {!profile.isOwn && <TouchableOpacity ref='button' onPress={e=>this.props.onPostOptions(e, this.refs.button)}
                                style={{position:'absolute', flexDirection:'row',  backgroundColor:'transparent', alignItems:'center', top:20*k, right:20*k}}>
                                <View style={{padding: 10*k, flexDirection:'row', alignItems:'center'}}>
                                  <Text style={{paddingRight:5*k, fontFamily:'Roboto-Light',fontSize:12, color:'rgb(155,155,155)'}}>{event.dateAsString} </Text>
