        ...
        {scale > 0 && (
          <View>
            <View style={styles.rowContainer}>
              <BotButtons bot={bot} subscribe={this.subscribe} unsubscribe={this.unsubscribe} isSubscribed={bot.isSubscribed} copyAddress={this.copyAddress} />
              ...
              {bot.geofence && <GeofenceCTA bot={bot} />}
            </View>
