                ...
                <View>
                    ...
                    <Card isDay={isDay} style={{ opacity: 0.95 }}>
                        ...
                        {!profile.isFollowed &&
                            <View>
                                <TouchableOpacity
                                    onPress={() => friendStore.add(profile)}
                                >
                                    <CellWithText isDay={isDay}>
                        ...
                        {profile.hidePosts &&
                            <View>
                                <TouchableOpacity
                                    onPress={() => state.showPosts(profile)}
                                >
                                    <CellWithText
                        ...
                        {!profile.isFollowed &&
                            ...
                            <View>
                                <TouchableOpacity
                                    onPress={() => state.hidePosts(profile)}
                                >
                                    <CellWithText
                        ...
                        {profile.isBlocked &&
                            <TouchableOpacity
                                onPress={() => friendStore.unblock(profile)}
                            >
                                <CellWithText
                                    isDay={isDay}
                                    textStyle={{ color: 'red' }}
