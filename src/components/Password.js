...
const styles = StyleSheet.create({
    ...
    signUpButton: {position:'absolute',bottom:30*k, left:30*k, right:30*k, height:50*k, borderWidth: 0,borderRadius:2*k,backgroundColor:'rgb(254,92,108)',alignItems:'center', justifyContent:'center'},
    login: {position:'absolute',bottom:40*k, left:20*k, right:20*k, alignItems:'center', justifyContent:'center'},
    ...
    tabContent: {top:240*k,fontSize:18*k,color:'white',fontFamily:'Roboto-Light',textAlign:'center',paddingLeft:52*k,paddingRight:52*k},
    loginText: {top:240*k,fontSize:18*k,color:'white',fontFamily:'Roboto-Regular',textAlign:'center',paddingLeft:52*k,paddingRight:52*k},
    tabHeader: {top:211*k,fontSize:30*k,textAlign:'center',color:'white',fontFamily:'Roboto-Regular'},
    signUpForm: {position:'absolute',top:240.4*k,right:30*k,left:30*k,borderRadius:2*k, backgroundColor:'rgba(255,255,255,0.12)'},
    ...
    usernameInput:{flex:1, height: 51*k, left:(18+15.2)*k, right:15.2*k, color: 'rgba(255,255,255,0.75)',fontFamily:'Roboto-Regular',fontSize:18*k },
    passwordInput:{flex:1, height: 51*k, left:5*k, right:15.2*k, color: 'rgba(255,255,255,0.75)',fontFamily:'Roboto-Regular',fontSize:18*k },
