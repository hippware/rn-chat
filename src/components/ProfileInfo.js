    ...
    render () {
        ...
        if (this.props.editMode) {
            return <Card  {...this.props} style={{opacity: 0.95}}>
                ...
                <MyAccountTextInput isDay={isDay} name='handle' image={require('../../images/iconUsernameSmall.png')}
                                    placeholder='Handle'/>
                <Cell image={require('../../images/iconPhoneSmall.png')}>{format(this.props.profile.phoneNumber)}</Cell>
                <Separator width={1}/>
                <MyAccountTextInput isDay={isDay} name='email' image={require('../../images/iconEmail.png')}
                                    placeholder='Email'/>
            </Card>
        } else {
            return <Card isDay={isDay} style={{opacity: 0.95}}>
                ...
                <Separator width={1}/>
                {!!profile.phoneNumber &&
                <Cell image={require('../../images/iconPhoneSmall.png')}>{format(profile.phoneNumber)}</Cell>}
