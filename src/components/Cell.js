...
export default class Cell extends React.Component {
  render() {
    const cell = <View style={[{flexDirection:'row', alignItems:'center', padding: 15*k}, this.props.style]}>
      ...
      {this.props.onRemove && <TouchableOpacity style={{justifyContent:'center', alignItems:'center'}} onPress={this.props.onRemove}><Image source={require('../../images/iconCloseSmall.png')}/></TouchableOpacity>}
