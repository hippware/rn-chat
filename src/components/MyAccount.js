...
export default class MyAccount extends React.Component {
    ...
    render () {
        ...
        return (
            <Screen isDay={isDay}>
                <GiftedForm testID="myAccount" name="myAccount"
                    ...
                    {profile.error &&
                    <Text style={{color: 'red', padding: 10, textAlign: 'center'}}>{profile.error}</Text>}

                    {this.props.editMode ? <ProfileInfo isDay={isDay} profile={profile} editMode={true}/> :
