...
export default class MyAccount extends React.Component {
  ...
  render(){
    ...
    return (
      <Screen isDay={isDay}>
        <GiftedForm testID="myAccount" name="myAccount" formStyles={{containerView: {backgroundColor:'transparent'}}}
          ...
          <SignUpAvatar avatar={avatar} profile={this.props.profile} isDay={isDay}
                        style={{top:5, backgroundColor:'rgb(243,244,246)',borderRadius:33*k, width:66*k, height:66*k}}/>
