...
export default class MessageButton extends Component {
  ...
  render(){
    return <TouchableOpacity style={[{position:'absolute', bottom:20*k, right:20*k, width:54,height:54, backgroundColor:'rgb(148,94,135)', borderRadius:27},this.props.style] }
                             onPress={statem.logged.createMessageContainer}>
