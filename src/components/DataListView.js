...
export default class DataListView extends Component {
  ...
  render(){
    ...
    return   <ListView ref="list" enableEmptySections={true}
                       ...
                       renderFooter={()=>{return this.state.pull && this.props.finished && this.props.footerImage ? <View style={{paddingTop:10, alignItems:'center', paddingBottom:21}}><Image source={this.props.footerImage}/></View>: null}}
    />
