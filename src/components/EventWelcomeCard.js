        ...
        return <View style={{paddingTop: 10}}>
            ...
            <View style={{
                ...
                <View style={{flex: 1, justifyContent: 'center'}}>
                    <CardText isDay={isDay}>Here you'll find everything you need to know about your friends' bots and
                        bots you'll subscribe to!</CardText>
                    <CardText style={{paddingTop: 10}} isDay={isDay}>Tap <View
                        style={{paddingTop: 15, width: 28, height: 30}}><Image style={{width: 28, height: 30}}
                                                                               source={require('../../images/actionMenu.png')}/></View>
                        to create your first bot</CardText>
                    <CardText style={{paddingTop: 10}} isDay={isDay}>Tap <View
                        style={{paddingTop: 15, width: 24, height: 22}}><Image style={{width: 24, height: 22}}
                                                                               source={require('../../images/iconMessage.png')}/></View>
                        to send messages to friends</CardText>
