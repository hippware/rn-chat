...
export default class CurrentLocationMarker extends Component {
  ...
  render() {
    ...
    return (
      <MapView.Marker tracksViewChanges={this.state.tracking} pointerEvents='none' style={{zIndex: 1000}} coordinate={{latitude: currentLoc.latitude, longitude: currentLoc.longitude}}>
