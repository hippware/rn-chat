    ...
    render() {
        ...
        return (
            <BackgroundImage source={require("../../images/bg2.png")}>
                {loaded && <GiftedForm name="signIn" formStyles={{containerView: styles.container}}
                                       onValidation={this.handleValidation.bind(this)}
                                       scrollEnabled={true} validators={validators}
                    ...
                    <Group style={styles.signUpForm}>
                        <Group style={styles.signUpFormInner}>
                            <SignUpTextInput name='handle' placeholder='Username' autofocus
                    ...
                    <View style={styles.agreeNote}>
                        <View style={{flex: 1, flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center'}}>
                            ...
                            <TouchableOpacity onPress={Actions.privacyPolicy}><Text style={styles.linkText}>Privacy
                                Policy</Text></TouchableOpacity>
                        </View>
                        <View style={{flex: 1, flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center'}}>
                            <Text style={styles.agreeNoteText}> and the </Text>
                            <TouchableOpacity onPress={Actions.termsOfService}><Text style={styles.linkText}>Terms of
