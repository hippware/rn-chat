...
export default class BotButton extends Component {
  ...
  render(){
    return <TouchableOpacity style={[{position:'absolute', bottom:20*k, right:20*k, width:54,height:54, backgroundColor:'rgb(254,92,108)', borderRadius:27,
          shadowOffset: {height:0, width:2}, shadowRadius:4, shadowOpacity:0.18},this.props.style] }
