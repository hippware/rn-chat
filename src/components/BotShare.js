...
import Bot, {SHARE_FOLLOWERS, SHARE_FRIENDS, SHARE_SELECT, VISIBILITY_WHITELIST, VISIBILITY_PUBLIC, VISIBILITY_FOLLOWERS, VISIBILITY_FRIENDS} from '../model/Bot';
        ...
        <Card isDay={location.isDay} >
          <Cell>
            <View style={{flex:1,paddingRight:10*k, alignItems:'center', justifyContent:'center'}}>
              <TextInput placeholder="Optional message" ref="title" placeholderTextColor='rgb(211,211,211)' value={this.message}
