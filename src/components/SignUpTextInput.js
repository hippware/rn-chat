...
export default class extends React.Component {
    render(){
        return <TextInputWidget
            ...
            widgetStyles={{textInputInline:{marginTop:0,height: NORMAL_HEIGHT*k, color: 'rgba(155,155,155,1)',fontFamily:'Roboto-Regular',fontSize:18*k },
                                rowContainer:{backgroundColor:'transparent', borderBottomWidth:this.props.last ? 0 : 2*k, borderColor:'rgba(155,155,155,0.15)'},
