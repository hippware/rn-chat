...
class FilterBar extends React.Component {
    render(){
        ...
        return <Tabs onSelect={el=>this.props.dispatch(filterActivities(el.props.name))} selected={this.props.activity.mode}
                     style={styles.tabs} iconStyle={styles.iconStyle}>
...
const styles = StyleSheet.create({
    tabs: {backgroundColor:'white', height:54*k, shadowOffset: {height:1, width:0}, shadowRadius:5*k, shadowOpacity:0.12, position:'relative',top:0},
    text: {
