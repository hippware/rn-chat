            ...
            <View style={[{flexDirection: 'row', flex: 1}, this.props.style]}>
                <View style={{width: 120 * k, height: 120 * k}}>
                    <View style={{position: 'absolute'}}>
                        <Image style={{width: 120 * k, height: 120 * k}}
                        ...
                        <View style={{position: 'absolute', top: 70 * k, right: 0, left: 0, bottom: 0}}>
                            ...
                            {bot.imagesCount > 0 && <View style={{
                                ...
                                <View style={{bottom: 2 * k, left: 2 * k}}><Text style={{
                                    fontSize: 11,
                                    color: 'white',
                                    backgroundColor: 'transparent',
                                    fontFamily: 'Roboto-Regular'
                                }}>{bot.imagesCount}</Text></View>
                            </View>}
                        </View>
                    ...
                    <View style={{flexDirection: 'row'}}>
                        <View style={{flex: 1, height: 75 * k}}>
                            ...
                            <View style={{flexDirection: 'row', paddingTop: 10 * k, alignItems: 'center'}}>
                                <Image style={{width: 15 * k, height: 16 * k}}
                                ...
                                <Text style={{
                                    ...
                                    fontFamily: 'Roboto-Regular'
                                }}>{bot.followersSize}</Text>
                                <View
                                    style={{width: 1 * k, height: 10 * k, backgroundColor: 'rgb(155,155,155)'}}></View>
                                <View style={{paddingLeft: 10 * k}}><Image style={{width: 14 * k, height: 17 * k}}
                                                                           source={require('../../images/iconBotLocation2.png')}/></View>
                                <Text style={{
                                    paddingLeft: 10 * k,
                                    paddingRight: 10 * k,
                                    fontSize: 12,
                        ...
                        <View style={{width: 60 * k}}>
                            ...
                            <TouchableOpacity onPress={() => statem.logged.profileDetailsContainer({
                                parent: '_home',
                                item: profile.user
                            })}><Text style={{
                                textAlign: 'right',
                            ...
                            }}>@{profile.handle}</Text></TouchableOpacity>
                        </View>
                    </View>
