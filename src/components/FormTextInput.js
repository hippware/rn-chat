  ...
  render() {
    ...
    return (
      <View>
        ...
        <Cell image={icon} style={{justifyContent: 'center', paddingTop: 2 * k}} imageStyle={{height: 20 * k, width: 20 * k, marginHorizontal: 5 * k}}>
          {icon ? null : <View style={{width: 30 * k}} />}
          <TextInput
            style={{flex: 1, color: colors.DARK_PURPLE, fontFamily: 'Roboto-Regular', fontSize: 18 * k}}
            placeholder={label}
