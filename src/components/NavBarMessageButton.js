...
export default class NavBarMessageButton extends Component {
  render(){
    ...
    const source = number>0 ? require('../../images/newMessages.png') : location.isDay ? require('../../images/iconMessage.png') : require('../../images/iconMessageNight.png');
    return <TouchableOpacity testID="rightNavButton"
      ...
      <Image source={source}/>
      {number > 0 && <View style={{position:'absolute', top:8, right:16, width:13, height:13, justifyContent:'center',alignItems:'center'}}>
