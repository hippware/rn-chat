  ...
  render(){
    ...
    if (this.props.onPress) {
      ...
      return <View  {...this.props} style={[styles.container,this.props.style]}>
        ...
        {!this.state.collapsed && <View style={[styles.inner, {backgroundColor}, this.props.innerStyle]} onLayout={props=>this.setState({totalHeight:props.nativeEvent.height})}>
            {React.Children.map(children, child=>child ? (props? React.cloneElement(child, props) : child) : false )}
        </View>}
        ...
        {this.props.collapsed !== undefined && !this.state.collapsed && <View style={{paddingTop:4,}}><TouchableOpacity onPress={()=>this.dismiss()}>
