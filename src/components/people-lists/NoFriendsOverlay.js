...
@autobind
@observer
class NoFriendsOverlay extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <Modal visible={Actions.currentScene === 'friends' && !model.friends.all.length && this.state.isVisible} transparent>
          ...
          <View style={styles.container}>
            ...
            <View style={{top: 230, width: 200, justifyContent: 'center', alignSelf: 'center', alignItems: 'center'}}>
              <Text style={{textAlign: 'center', color: 'white', fontFamily: 'Roboto-Regular', fontSize: 18}}>
                <Text style={{fontFamily: 'Roboto-Medium'}}>Tinyrobot</Text>
                <Text>
                  {' '}
...
export default NoFriendsOverlay;
