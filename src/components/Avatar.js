...
export default class extends React.Component {
    render(){
        console.log("AVATAR IMAGE:", JSON.stringify(this.props.image));
        return <View>
                {this.props.image && <Image source={{uri:this.props.image.uri}}
            ...
            {this.props.showFrame && <View style={{position:'absolute',top:0,left:0,right:0,bottom:0}}><Image source={require("../../images/avatarFrame.png") } style={{width:40*k,height:40*k}}/></View>}
        </View>
    }
}