...
class MenuImage extends React.Component {
    render() {
        return <Image source={this.props.image} resizeMode={Image.resizeMode.contain}
    ...
    render() {
        return <TouchableOpacity onPress={() => {
            ...
            <View style={[{
                ...
                <View style={{width: 80 * k, alignItems: 'center'}}>{this.props.icon ||
                <MenuImage image={this.props.image}/>}</View>
    ...
    render() {
        ...
        return <View style={{flex: 1, backgroundColor: 'rgba(63,50,77,1)'}}>
            ...
            <MenuItem testID="myAccountMenuItem" innerStyle={{flexDirection: 'column'}}
                ...
                <Text style={{color: 'rgba(255,255,255,0.57)', fontFamily: 'Roboto-Regular', fontSize: 12}}>View
                    Account</Text>
            </MenuItem>
            <MenuItem onPress={statem.homeContainer.home} image={require("../../images/menuHome.png")}><Text
                style={styles.text}>HOME</Text></MenuItem>
            <MenuItem onPress={() => statem.homeContainer.fullMap({force: true})}
                      image={require("../../images/menuExplore.png")}><Text style={styles.text}>EXPLORE
                NEARBY</Text></MenuItem>
            <MenuItem onPress={statem.drawerTabs.friendsContainer} image={require("../../images/menuFriends.png")}><Text
                style={styles.text}>PEOPLE</Text>
                <Badge>{model.friends.newFollowers.length}</Badge>
                <View style={{width: 22}}></View></MenuItem>
            <MenuItem onPress={statem.drawerTabs.botsContainer} image={require("../../images/menuBots.png")}><Text
                style={styles.text}>BOTS</Text></MenuItem>
        </View>;
    }
}
