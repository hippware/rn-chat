  ...
  (function (root, factory) {
    ...
    if (!Function.prototype.bind) {
      Function.prototype.bind = function (obj /* , arg1, arg2, ... */) {
        ...
        return function () {
          return func.apply(obj || this, _concat.call(_args, _slice.call(arguments, 0)));
        };
      };
    }
  ...
  (function (root, factory) {
    ...
    */
      ...
      serialize(elem) {
        ...
        for (i = 0; i < elem.attributes.length; i++) {
          if (elem.attributes[i].nodeName != '_realname') {
            result += ` ${elem.attributes[i].nodeName}='${elem.attributes[i].value
              .replace(/&/g, '&amp;')
              .replace(/\'/g, '&apos;')
              .replace(/>/g, '&gt;')
              .replace(/</g, '&lt;')}'`;
    ...
    Strophe.Connection.prototype = {
       ...
       */
      _changeConnectStatus(status, condition) {
    ...
    Strophe.SASLPlain.prototype.onChallenge = function (connection) {
      ...
      auth_str += '\u0000';
      auth_str += connection.authcid;
      auth_str += '\u0000';
      auth_str += connection.pass;
...
*/
  ...
  (function (root, factory) {
    if (typeof define === 'function' && define.amd) {
      define('strophe-bosh', ['strophe-core'], core => {
...
*/
  ...
  (function (root, factory) {
    if (typeof define === 'function' && define.amd) {
      define('strophe-websocket', ['strophe-core'], core => {
        return factory(core.Strophe, core.$build);
      });
    } else {
      // Browser globals
    ...
    Strophe.Websocket.prototype = {
       ...
       */
      _check_streamerror(bodyWrap, connectstatus) {
        var errors;
        if (bodyWrap.getElementsByTagNameNS) {
  ...
  (function (root) {
    if (typeof define === 'function' && define.amd) {
      define('strophe', ['strophe-core', 'strophe-bosh', 'strophe-websocket'], wrapper => {
        return wrapper;
      });
    }
  }(this));
