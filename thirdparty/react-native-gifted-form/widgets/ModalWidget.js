...
module.exports = React.createClass({
    ...
    renderDisclosure() {
        if (this.props.disclosure === true) {
            return <Image style={this.getStyle('disclosure')} resizeMode={Image.resizeMode.contain} source={require('../icons/disclosure.png')} />;
        }
        return null;
    },
    ...
    onPress() {
        ...
        var route = {
            renderScene(navigator) {
                ...
                return <GiftedFormModal {...others} navigator={navigator} isModal children={_self._childrenWithProps} />;
            },
            getTitle() {
