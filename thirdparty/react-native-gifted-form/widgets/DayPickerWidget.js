    ...
    render() {
        return (
            <View>
                ...
                >
                    <SelectWidget name={this.props.name + '$year'} multiple={false} onSelect={(value) => {
                        this._onSelect('year', value)
                    }}>
                ...
                >
                    <SelectWidget name={this.props.name + '$month'} multiple={false} onSelect={(value) => {
                        this._onSelect('month', value)
                    }}>
