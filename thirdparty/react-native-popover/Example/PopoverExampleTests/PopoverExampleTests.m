...
@interface PopoverExampleTests : XCTestCase
...
- (void)testRendersWelcomeScreen {
  ...
  NSDate *dateAsString = [NSDate dateWithTimeIntervalSinceNow:TIMEOUT_SECONDS];
  BOOL foundElement = NO;
  NSString *redboxError = nil;

  while ([dateAsString timeIntervalSinceNow] > 0 && !foundElement && !redboxError) {
