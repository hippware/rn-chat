...
if (latestTag !== versionTag) {
    console.log(
        chalk.yellow(
            `WARNING: promoting a version that does not match the latest known git tagged version. Latest: ${latestTag}. Version: ${versionTag}`
        )
    );
}

const nevercodeDeployUrl =
    'https://app.nevercode.io/api/projects/2e4be066-0061-4c95-84ed-1e8ee2de554d/build?token=c88383cd616303c448b846665bc1fb0a&branch=deploy-stage';
